$(function(){
  $("body").on('focus', '.runsite-input-progress input, .runsite-input-progress textarea', function() {
    $(this).parent().addClass('focus');
    runsiteInputProgressSet($(this));
  });

  $("body").on('blur', '.runsite-input-progress input, .runsite-input-progress textarea', function() {
    $(this).parent().removeClass('focus');
  });

  $("body").on('keyup', '.runsite-input-progress input, .runsite-input-progress textarea', function() {
    var curr = $(this);
